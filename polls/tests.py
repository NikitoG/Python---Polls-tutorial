...
def create_question(question_text, days):
    """
    Create a question with the given 'question_text' and published the given number of 'days' offset to now (negative for questions published in the past, positive for questionsuestion tha have yet to be published).
    """
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        ...
        self.assertContains(response, "No pools are aveilable.")
    ...
    def test_index_vies_with_a_future_qustion(self):
        """
    ...
    def test_index_view_with_future_and_past_question(self):
        """
        Even if both future and past questions exists, only past should be displayed.
        """
        create_question(question_text="Past question.", days=-30)
        create_question(question_text="Future question.", days=30)
        response = self.client.get(reverse('polls:index'))
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_past_question(self):
        """
        The detail view of question with a pub_date in the past should display the question's text.
        """
